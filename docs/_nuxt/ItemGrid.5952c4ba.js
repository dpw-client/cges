                  ...
                  { key: l, style: je(`width: 300px; border-top: 2px solid ${d.cardTypes[l.type]};`) },
                  {
                    default: r(() => [
                      a(
                        U,
                        null,
                        Fe({ default: r(() => ["title" in l ? (s(), b(E, { key: 0 }, { default: r(() => [m("b", null, y(l.title), 1)]), _: 2 }, 1024)) : k("", !0), "subtitle" in l ? (s(), b(z, { key: 1 }, { default: r(() => [D(y(l.subtitle), 1)]), _: 2 }, 1024)) : k("", !0)]), _: 2 }, ["abstract_image" in l ? { name: "prepend", fn: r(() => [a(A, { size: "64", rounded: "0" }, { default: r(() => [a(N, { src: `/img/${l.abstract_image}` }, null, 8, ["src"])]), _: 2 }, 1024)]), key: "0" } : void 0]),
                        1024
                      ),
                      a(
                        q,
