import { s as ne, u as S, v as O, r as s, x as y, y as w, z as Me, A as Ne, B as je, C as ge, h as Z, D as he, F as xe, n as V, c as Se, b as B, w as $, o as ee, E as De, q as Ee, a as be, t as Ie } from "./entry.ccd7e3b1.js";
import { s as we } from "./intersectionObserver.aab72029.js";
import { i as Le } from "./ItemList.b4b96ae2.js";
import { _ as Pe } from "./_plugin-vue_export-helper.c27b6911.js";
import { V as Ve } from "./VImg.09de5684.js";
import "./resizeObserver.a034768f.js";
/**
...
const We = {
    components: { Carousel: He, Slide: ze, Pagination: Ue, il: Le },
    async mounted() {
        ...
        { class: "mt-4 h-75 ma-auto", autoplay: 4e3, "items-to-show": 2.5, "wrap-around": !0 },
        {
          ...
          default: $(() => [
            ...
            Se(
              xe,
              null,
              De(r.carousel, (p) => (ee(), Ee(g, { key: p }, { default: $(() => [B(Ve, { class: "carousel__item", src: `/img/${p.picture}`, onClick: (_) => i.openPDF(p.file) }, { default: $(() => [be("div", Ge, [be("div", qe, Ie(p.title), 1)])]), _: 2 }, 1032, ["src", "onClick"])]), _: 2 }, 1024))),
              128
            )),
          ]),
          _: 1,
